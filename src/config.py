...
_C.dataset = 'TDBRAIN' 
_C.root = 'data/TDBRAIN'  # chemin racine des données
_C.out_root = 'outputs/'  # dossier pour TensorBoard, logs, etc.
_C.num_workers = 4
_C.print_freq = 1
_C.pretrain = False
_C.pretrained_model = ''
...
_C.preprocessing.path.electrode_locations = 'data/TDBRAIN/elec_loc.csv'  # normes 1020
_C.preprocessing.path.data_dir = 'data/TDBRAIN/raw'  # dossier contenant les .vhdr
_C.preprocessing.path.save_dir = 'data/TDBRAIN/preprocessed'  # sortie du préprocessing
...
_C.connectome.frequency_band.beta = [12., 30.]  # utilisé pour TBR

_C.connectome.methods = ['coh', 'wpli']  # cohérence et weighted phase lag index

_C.connectome.path = CN()
_C.connectome.path.data_dir = 'data/TDBRAIN/preprocessed'  # entrée connectome
_C.connectome.path.save_dir = 'data/TDBRAIN/connectome'  # sortie connectome
